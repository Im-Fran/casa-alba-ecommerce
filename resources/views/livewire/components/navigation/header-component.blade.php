        ...
        <div class="bg-primary transition-all duration-[.75s]" x-bind:class="{'px-2 py-5 rounded-none': mobileNavOpen, 'mx-2 mt-5 rounded-[1rem]': !mobileNavOpen}">
            <div class="flex items-center justify-between p-2">
                ...
                <div class="flex items-center space-x-4">
                    @env(['local'])
                        <a target="_blank" href="{{ Str::replaceLast('/', '', url(':8025')) }}" class="text-neutral-100 text-sm font-medium hover:text-secondary"><x-lucide-mail class="w-6 h-6 md:w-8 md:h-8"/></a>
                    @endenv
