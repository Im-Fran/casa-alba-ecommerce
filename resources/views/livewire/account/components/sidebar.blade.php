<div class="bg-white p-4 rounded-lg shadow-lg top-20 w-full">
    <h2 class="text-xl font-semibold mb-4 text-primary-content">Mi Cuenta</h2>
    ...
    <div class="space-y-2 w-full">
        ...
        <a href="{{ route('account.security') }}" class="flex items-center gap-2 p-2 rounded-lg hover:bg-neutral-100 transition-colors" wire:current.exact="text-primary-content">
            <x-icon name="o-lock-closed" class="w-5 h-5" />
            <span>Seguridad</span>
        </a>

        <a href="{{ route('account.addresses') }}" class="flex items-center gap-2 p-2 rounded-lg hover:bg-neutral-100 transition-colors" wire:current.exact="text-primary-content">
