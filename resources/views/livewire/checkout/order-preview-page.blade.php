        ...
        <div class="container max-w-4xl mx-auto">
            <div class="bg-white p-6 md:p-10 rounded-lg shadow-lg">
                    ...
                    <div class="flex flex-col md:flex-row justify-between gap-4">
                        <div class="grid grid-cols-2 gap-4 w-full md:w-2/3">
                            ...
                            <div>
                                ...
                                <p class="font-medium">{{ $order->placed_at?->format('d/m/Y H:i') ?? $order->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                            <div>
                ...
                <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <x-button link="{{ route('account.orders') }}" class="btn btn-primary" icon="o-clipboard-document-list">
                        Mis Pedidos
                    </x-button>
                </div>
            </div>
