        ...
        <div class="container max-w-4xl mx-auto">
            <div class="bg-white p-6 md:p-10 rounded-lg shadow-lg">
                <div class="flex flex-col items-center mb-8 text-center">
                    ...
                    <h1 class="text-3xl font-bold">Pedido Pendiente</h1>
                    <p class="text-gray-600 mt-2">Tienes un pedido pendiente de pago. Puedes continuar con tu compra o cancelarla.</p>
                </div>
                ...
                <div class="border-t border-b border-gray-200 py-6 my-6">
                    <div class="flex flex-col gap-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <h3 class="text-sm font-semibold text-gray-500">Fecha de Creación</h3>
                ...
                <div class="mt-10 flex flex-col sm:flex-row justify-center gap-4">
                    <x-button wire:click="cancelOrder" class="btn btn-outline" icon="o-x-mark">
                        Cancelar Pedido
                    </x-button>
                    <x-button wire:click="continueCheckout" class="btn btn-primary" icon="o-credit-card">
