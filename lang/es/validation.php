...
return [
    ...
    'credit_card'          => [
        'card_checksum_invalid'               => 'El número de la tarjeta no es válido.',
        'card_cvc_invalid'                    => 'El código de seguridad de la tarjeta no es válido.',
        'card_expiration_date_format_invalid' => 'El formato de la fecha de vencimiento de la tarjeta no es válido.',
        'card_expiration_date_invalid'        => 'La fecha de vencimiento de la tarjeta no es válida.',
        'card_invalid'                        => 'El número de la tarjeta no es válido.',
        'card_length_invalid'                 => 'El número de la tarjeta no tiene la longitud correcta.',
        'card_pattern_invalid'                => 'El número de la tarjeta no coincide con el patrón esperado.',
    ],
